    ...
    public static WebDriver getDriver() {
        ...
        if (driver == null) {
            ...
            if ("chrome".equals(browser)) {
                ...
                log.info("Chrome Driver successfully created!");
                ...
                log.error("System browser - {} - is not one of the supported browser!", browser);
            }
        }
//        driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(10));
        driver.manage().window().maximize();  //one way
//        driver.manage().window().fullscreen(); // another way
//        ChromeOptions options = new ChromeOptions(); options.addArguments("startmaximized");

        //System.out.println(driver.manage().window().getSize()); // size i bulup penceyreyi istedigimiz kadar buyutebiliriz
//        Dimension dm = new Dimension(555,999);  //an other way
